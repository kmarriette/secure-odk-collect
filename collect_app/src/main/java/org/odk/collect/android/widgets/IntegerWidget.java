...
public class IntegerWidget extends StringWidget {
    ...
    public IntegerWidget(Context context, FormEntryPrompt prompt, boolean readOnlyOverride, AttributeProfile attributeProfile) {
        super(context, prompt, readOnlyOverride,attributeProfile);
