...
public class AudioWidget extends QuestionWidget implements FileWidget {
    ...
    public AudioWidget(Context context, FormEntryPrompt prompt, AttributeProfile attributeProfile) {
        this(context, prompt, new FileUtil(), new MediaUtil(),attributeProfile);
    }

    AudioWidget(Context context, FormEntryPrompt prompt, @NonNull FileUtil fileUtil, @NonNull MediaUtil mediaUtil, AttributeProfile attributeProfile) {
