...
public class FormsProvider extends ContentProvider {
    ...
    public synchronized Uri insert(@NonNull Uri uri, ContentValues initialValues) {
        ...
        /*mkk sensitivity value?
        if (!values.containsKey(FormsColumns.FORM_SENSITIVITY)) {
            values.put(FormsColumns.FORM_SENSITIVITY, form.getFormSensitivity());
            Timber.i("sensitivity is on");

        } else {
            Timber.i("sensitivity is where?");
        }
    ...
    static {
        ...
        sFormsProjectionMap.put(FormsColumns.FORM_SENSITIVITY, FormsColumns.FORM_SENSITIVITY);
    }
}
