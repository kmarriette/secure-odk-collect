...
public class Instance {
    ...
    private String formSensitivity; //MKK sensitivity
    ...
    private Instance(Builder builder) {
        ...
        formSensitivity = builder.formSensitivity;
    }
    ...
    public static class Builder {
        ...
        private String displaySubtext;
        private Long deletedDate;
        private String formSensitivity;
        ...
        public Builder formSensitivity(String formSensitivity) {
            this.formSensitivity = formSensitivity;
            return this;
        }
    ...
    public String getFormSensitivity() {
        return formSensitivity;
    }
}
