...
public class DateTimeWidget extends QuestionWidget implements BinaryWidget {
    ...
    public DateTimeWidget(Context context, FormEntryPrompt prompt, AttributeProfile attributeProfile) {
        ...
        if (appearance != null && appearance.contains("ethiopian")) {
            dateWidget = new EthiopianDateWidget(context, prompt,attributeProfile);
        } else {
            dateWidget = new DateWidget(context, prompt,attributeProfile);
        }
        timeWidget = new TimeWidget(context, prompt,attributeProfile);
