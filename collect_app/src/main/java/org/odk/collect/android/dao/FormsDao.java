...
public class FormsDao {
        ...
        if (cursor != null) {
            try {
                while (cursor.moveToNext()) {
                    ...
                    //MKK Sensitivity
                    int formSensitivityColumnIndex = cursor.getColumnIndex(FormsProviderAPI.FormsColumns.FORM_SENSITIVITY);
    ...
    public ContentValues getValuesFromFormObject(Form form) {
        ...
        values.put(FormsProviderAPI.FormsColumns.FORM_SENSITIVITY, form.getFormSensitivity());
