...
public class InstancesDao {
        ...
        if (cursor != null) {
            try {
                while (cursor.moveToNext()) {
                    ...
                    int formSensitivityColumnIndex = cursor.getColumnIndex(InstanceProviderAPI.InstanceColumns.FORM_SENSITIVITY); //MKK sensitivity
                    ...
                    Instance instance = new Instance.Builder()
                            ...
                            .formSensitivity(cursor.getString(formSensitivityColumnIndex))
                            .build();
    ...
    public ContentValues getValuesFromInstanceObject(Instance instance) {
        ...
        values.put(InstanceProviderAPI.InstanceColumns.FORM_SENSITIVITY, instance.getFormSensitivity());
        return values;
    }
}
