...
public class DiskSyncTask extends AsyncTask<Void, String, String> {
            ...
            if (formDir.exists() && formDir.isDirectory()) {
                ...
                //         discard files not ending with ".xml" or ".xhtml"
                {
                    ...
                    for (File addMe : formDefs) {
                        ...
                        if (!addMe.getName().startsWith(".")
                                ...
                                ".xhtml"))) {
                            //mmk
                            Timber.i("[%d] Forms loaded: %s", instance, addMe.getName());
                ...
                while (!formsToAdd.isEmpty()) {
                    ...
                    try {
                        ...
                        Timber.i("Form saved %s ", values.get(FormsColumns.DISPLAY_NAME));
    ...
    /**
    // MKK sensitivity
    //public boolean checkSensitivity(File formDef){

         * check if form def contains sensitivity tag/element/node
    ...
    private ContentValues buildContentValues(File formDefFile) throws IllegalArgumentException {
        ...
        //String sensitivity = fields.get(FileUtils.SENSITIVITY);
        ...
        if (sensitivity != null) {
            updateValues.put(FormsColumns.FORM_SENSITIVITY, sensitivity);
            Timber.i("sensitivity %s", sensitivity);
        } else {
            Timber.i("sensitivity is null");
        }
