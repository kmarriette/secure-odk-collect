...
public class VideoWidget extends QuestionWidget implements FileWidget {
    ...
    public VideoWidget(Context context, FormEntryPrompt prompt,AttributeProfile attributeProfile) {
        this(context, prompt, new FileUtil(), new MediaUtil(),attributeProfile);
    }

    public VideoWidget(Context context, FormEntryPrompt prompt, @NonNull FileUtil fileUtil, @NonNull MediaUtil mediaUtil, AttributeProfile attributeProfile) {
