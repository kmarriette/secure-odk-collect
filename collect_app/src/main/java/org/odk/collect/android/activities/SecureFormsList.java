...
/**
 * Created by kmarriette on 20/05/2019.
 */

public class SecureFormsList extends FormListActivity implements DiskSyncListener, AdapterView.OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.secure_forms));
